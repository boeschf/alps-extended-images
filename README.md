...
| `vllm-cuda:alps7-dev`        | `pytorch-cuda:26.07-py3` | vLLM serving workloads built from source (v0.30.0, Torch 2.13 stable-libtorch APIs), with UCCL-EP over Slingshot CXI |
| `vllm-rocm:alps7-dev`        | `pytorch-rocm:rocm10.0-ubuntu24.04-py3.12-torch2.13` | vLLM serving workloads built from source for ROCm/MI300 (v0.30.0), with AITER and UCCL-EP over Slingshot CXI |
